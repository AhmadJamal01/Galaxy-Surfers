...
class ClearColorState : public our::State {
    ...
    void onInitialize() override {
        ...
        nlohmann::json color_config = getApp()->getConfig();
        //Extracting the color values
        float r = color_config["scene"]["clear-color"]["r"];
        float g = color_config["scene"]["clear-color"]["g"];
        float b = color_config["scene"]["clear-color"]["b"];
        float a = color_config["scene"]["clear-color"]["a"];
        //Setting the color
